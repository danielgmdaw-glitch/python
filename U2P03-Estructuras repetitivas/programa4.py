...
#hasta que ingrese 45 como la número de salida secreto, en cuyo caso el mensaje 
...
#• Versión 2: Realmente no es necesario usar la instrucción break. 
# Diseña una solución donde no se use break y el bucle while controle la condición de salida.

# Versión 1: usando break
while True:
